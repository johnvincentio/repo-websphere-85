...
public class PropertiesPanel extends JPanel {
	...
	public PropertiesPanel (AppProps appProps) {
		...
		message.println("jacl_root_path ");
		message.println("	Root directory of jacl files.");
		message.println("	value: "+appProps.getJaclRootPath());
		message.println("	default: "+defProps.getJaclRootPath());
		message.println("");
		...
		message.println("");
		message.println("mysql_lib_path");
		message.println("	Path to MySQL jars.");
		message.println("	value: "+appProps.getMySQLLibPath());
		message.println("	default: "+defProps.getMySQLLibPath());
