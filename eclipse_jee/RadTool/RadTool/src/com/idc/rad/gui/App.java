...
import com.idc.rad.app.AppJacl;
...
public class App extends JFrame {
	...
	public App (String msg, String[] args) {
		...
		System.out.println("m_appProps.getWorkspaceServerPath "+m_appProps.getWorkspaceServerPath());
		m_appJacl = new AppJacl (m_appProps);
		System.out.println("m_appJacl "+m_appJacl);
	...
	public AppJacl getAppJacl() {return m_appJacl;}
	...
	public void doServersJacl (String jaclDir, String jaclFile, String earName, String earFile, String node) {
		System.out.println("App:doServersJacl; node :"+node+":");
		Servers servers = new Servers (m_appProps);
		ServersJaclPanel pane = new ServersJaclPanel (this, m_appProps, 
				new ServerTreePanel (this, servers), jaclDir, jaclFile, earName, earFile, servers.getServer(node));
		m_bWorkspacesActive = false;
		getContentPane().removeAll();
		getContentPane().add(pane);
		pack();
