...
public class ServersJaclPanel extends JPanel implements ActionListener {
	...
	private JTextField m_param3aField = new JTextField(50);
	...
	private JTextField m_jaclDirField = new JTextField(50);
	...
	public ServersJaclPanel (App app, AppProps appProps, ServerTreePanel serverTreePanel, 
			String jaclDir, String jaclFile, String earName, String earFile, Servers.Server server) {
		m_app = app;
		m_serversJacl = new ServersJacl (appProps, jaclDir, jaclFile, server);
		...
		m_jaclDirField.setText(m_serversJacl.getJaclDir());

		m_param1Field.setText(m_serversJacl.getJaclRootPath());
		...
		m_param3aField.setText(m_serversJacl.getMySQLLibPath());
		...
		pane1.add (new JLabel("Jacl Directory "));
		pane1.add (m_jaclDirField);
		pane1.add (new JLabel("JaclRootPath "));
		...
		pane1.add (new JLabel("MySQLLibPath "));
		pane1.add (m_param3aField);
	...
	public void actionPerformed (ActionEvent e) {
		...
		if (source instanceof JButton) {
			...
			if (source == m_btnApp) {
				...
				m_serversJacl.setJaclDir (m_jaclDirField.getText().trim());
				m_serversJacl.setJaclRootPath (m_param1Field.getText().trim());
				...
				m_serversJacl.setMySQLLibPath (m_param3aField.getText().trim());
