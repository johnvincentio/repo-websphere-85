...
public class ServerTreePanel extends JPanel implements ActionListener {
	...
	private JMenuItem m_menuItemHercDeployMapQuest;
	private JMenuItem m_menuItemHercDeployErrorFramework;
	...
	private JMenuItem m_menuItemHercUnDeployMapQuest;
	private JMenuItem m_menuItemHercUnDeployErrorFramework;
...
*/
		...
		if (m_app.isJaclActive()) {
			...
			m_menuItemHercDeployMapQuest = new JMenuItem("MapQuestEAR");
			m_menuItemHercDeployMapQuest.addActionListener(this);
			m_menuHercDeployJacl.add(m_menuItemHercDeployMapQuest);

			m_menuItemHercDeployErrorFramework = new JMenuItem("ErrorFrameworkEAR");
			m_menuItemHercDeployErrorFramework.addActionListener(this);
			m_menuHercDeployJacl.add(m_menuItemHercDeployErrorFramework);
			...
			m_menuItemHercUnDeployMapQuest = new JMenuItem("MapQuestEAR");
			m_menuItemHercUnDeployMapQuest.addActionListener(this);
			m_menuHercUndeployJacl.add(m_menuItemHercUnDeployMapQuest);

			m_menuItemHercUnDeployErrorFramework = new JMenuItem("ErrorFrameworkEAR");
			m_menuItemHercUnDeployErrorFramework.addActionListener(this);
			m_menuHercUndeployJacl.add(m_menuItemHercUnDeployErrorFramework);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() instanceof JMenuItem) {
			...
			else if (source == m_menuItemHercDeployMapQuest) {
				if (strNode != null) m_app.doServersJacl ("hercDeploy.jacl", "MapQuestEAR", "MapQuestEAR.ear", strNode);
			}
			else if (source == m_menuItemHercDeployErrorFramework) {
				if (strNode != null) m_app.doServersJacl ("hercDeploy.jacl", "ErrorFrameworkEAR", "ErrorFrameworkEAR.ear", strNode);
			}
			...
			else if (source == m_menuItemHercUnDeployMapQuest) {
				if (strNode != null) m_app.doServersJacl ("hercUndeploy.jacl", "MapQuestEAR", null, strNode);
			}
			else if (source == m_menuItemHercUnDeployErrorFramework) {
				if (strNode != null) m_app.doServersJacl ("hercUndeploy.jacl", "ErrorFrameworkEAR", null, strNode);
			}
